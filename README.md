...
# 安装 #
    wget https://raw.githubusercontent.com/lianfengyeo/Fail2ban/master/fail2ban.sh && bash fail2ban.sh 2>&1 | tee fail2ban.log
...
# 卸载 #
    wget https://raw.githubusercontent.com/lianfengyeo/Fail2ban/master/fail2ban.sh && bash uninstall.sh
